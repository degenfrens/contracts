/**
 *Submitted for verification at basescan.org on 2024-05-07
*/
...
contract Frens is ERC20, Ownable {
    ...
    constructor(uint256 _initialSupply, uint256 _maxTokenAmount) ERC20("Degen Frens", "FRENS") Ownable(msg.sender) {
    ...
    function addBlacklistedAddress(address _account) external onlyOwner {
        require(!blacklistedAddresses[_account], "Address already blacklisted");
        blacklistedAddresses[_account] = true;
        emit BlacklistedAddressAdded(_account);
    }

    function removeBlacklistedAddress(address _account) external onlyOwner {
    ...
    function transfer(address _to, uint256 _amount) public override returns (bool) {
        require(!blacklistedAddresses[_to], "Receiver is blacklisted");
